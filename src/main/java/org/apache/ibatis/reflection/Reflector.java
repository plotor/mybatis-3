...
public class Reflector {
    ...
    private Method pickBetterSetter(Method setter1, Method setter2, String property) {
        ...
        setTypes.put(property, this.typeToClass(paramTypes[0]));
        return null;
    }
    ...
    private void addSetMethod(String name, Method method) {
        ...
        setTypes.put(name, this.typeToClass(paramTypes[0]));
    }
    ...
    private void addSetField(Field field) {
        if (this.isValidPropertyName(field.getName())) {
            ...
            setTypes.put(field.getName(), this.typeToClass(fieldType));
        }
    }
    ...
    private void addGetField(Field field) {
        if (this.isValidPropertyName(field.getName())) {
            ...
            Type fieldType = TypeParameterResolver.resolveFieldType(field, type);
            getTypes.put(field.getName(), this.typeToClass(fieldType));
        }
    }
