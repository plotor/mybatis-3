...
public class MapperMethod {
        ...
        private MappedStatement resolveMappedStatement(Class<?> mapperInterface, String methodName,
            ...
            for (Class<?> superInterface : mapperInterface.getInterfaces()) {
                if (declaringClass.isAssignableFrom(superInterface)) {
                    MappedStatement ms = this.resolveMappedStatement(superInterface, methodName,
    ...
    public static class MethodSignature {
        ...
        public RowBounds extractRowBounds(Object[] args) {
            return this.hasRowBounds() ? (RowBounds) args[rowBoundsIndex] : null;
        }
        ...
        public ResultHandler extractResultHandler(Object[] args) {
            return this.hasResultHandler() ? (ResultHandler) args[resultHandlerIndex] : null;
        }
